...
public class StartupDataInit {
	...
	public void init() {
		...
		service.sauvegardeCollegue(new Collegue("Marty", "Nicolas", LocalDate.of(1987, 3, 31),
				...
				"pass1", Arrays.asList("ROLE_ADMIN", "ROLE_USER")));
		...
		service.sauvegardeCollegue(new Collegue("Paul", "Gurpratap Singh", LocalDate.of(1987, 12, 18),
				"https://www.petite-entreprise.net/donnees/cms/originales/deception-salarie.jpg", "paul@societe.com",
				"pass3", Arrays.asList("ROLE_USER")));

		service.sauvegardeCollegue(new Collegue("Biraben", "Hugo", LocalDate.of(2000, 7, 14),
