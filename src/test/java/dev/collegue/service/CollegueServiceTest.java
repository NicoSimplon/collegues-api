...
public class CollegueServiceTest {
	...
	public void testSauvegarderCollegueWithShorterNom() {
		...
		Collegue collegue = new Collegue("m", "Nicolas", LocalDate.of(1987, 3, 31),
	...
	public void testSauvegarderCollegueWithShorterPrenom() {
		...
		Collegue collegue = new Collegue("Marty", "n", LocalDate.of(1987, 3, 31),
				"https://www.petite-entreprise.net/donnees/cms/originales/deception-salarie.jpg", "marty@societe.com");
	...
	public void testSauvegarderCollegueWithInvalidEmail() {
		...
		Collegue collegue = new Collegue("Marty", "Nicolas", LocalDate.of(1987, 3, 31),
				"https://www.petite-entreprise.net/donnees/cms/originales/deception-salarie.jpg", "marty.societe.com");
	...
	public void testSauvegarderCollegueWithInvalidImgUrl() {
		...
		Collegue collegue = new Collegue("Marty", "Nicolas", LocalDate.of(1987, 3, 31),
				"s://www.petite-entreprise.net/donnees/cms/originales/deception-salarie.jpg", "marty@societe.com");
	...
	public void testSauvegarderCollegueWithInvalidAge() {
		...
		Collegue collegue = new Collegue("Marty", "Nicolas", LocalDate.of(2018, 3, 31),
				"https://www.petite-entreprise.net/donnees/cms/originales/deception-salarie.jpg", "marty@societe.com");
	...
	public void testModifierCollegueWithShorterEmail() {
		...
		LOG.info("Etant donné un nouvel objet Collegue initié");
		Collegue collegue = new Collegue("Marty", "Nicolas", LocalDate.of(1987, 3, 31),
				"https://www.petite-entreprise.net/donnees/cms/originales/deception-salarie.jpg", "nico@mail.fr");
		String matricule = UUID.randomUUID().toString();
		collegue.setMatricule(matricule);
	...
	@Test(expected = CollegueInvalideException.class)
	public void testModifierCollegueWithInvalidImgUrlLengthMax() {
		...
		LOG.info("Lorsqu'on sauvegarde ce collègue avec une url d'image contenant plus de 255 caractères");
		LOG.info("Alors une exception de type CollegueInvalidException est lancée");
		Mockito.when(this.crMock.findById(matricule)).thenReturn(Optional.of(collegue));
		service.modifierPhotoUrl(matricule, "http://www.img.");

	}
	
	@Test(expected = CollegueInvalideException.class)
	public void testModifierCollegueWithInvalidImgUrlLengthMin() {
		...
		LOG.info("Lorsqu'on sauvegarde ce collègue avec une url d'image contenant moins de 7 caractères");
		LOG.info("Alors une exception de type CollegueInvalidException est lancée");
		Mockito.when(this.crMock.findById(matricule)).thenReturn(Optional.of(collegue));
		service.modifierPhotoUrl(matricule, "http:/");
	}
